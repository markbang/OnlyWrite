...
export const messages: MessagesByLocale = {
  en: {
    ...
    dashboard: {
      ...
      welcomeSubtitle: 'Here\'s what\'s happening with your writing',
      ...
      newDocumentDesc: 'Create a new markdown file',
      openFolder: 'Open Folder',
      openFolderDesc: 'Select a workspace folder',
      starred: 'Starred',
      starredDesc: 'View your starred files',
      statistics: 'Statistics',
      statisticsDesc: 'View detailed analytics',
      proFeatureTitle: 'Upgrade to Pro',
      proFeatureDesc: 'Unlock unlimited sync, advanced analytics, and premium templates.',
  ...
  zh: {
    ...
    dashboard: {
      ...
      streak: '连续写作',
      recentFiles: '最近文件',
      recentFilesDesc: '继续上次的工作',
      quickActions: '快捷操作',
      quickActionsDesc: '快速访问常用功能',
      newDocument: '新建文档',
      newDocumentDesc: '创建新的 markdown 文件',
      openFolder: '打开文件夹',
      openFolderDesc: '选择工作文件夹',
      starred: '星标文件',
      starredDesc: '查看您的星标文件',
      statistics: '统计分析',
      statisticsDesc: '查看详细的数据分析',
      proFeatureTitle: '升级到专业版',
      proFeatureDesc: '解锁无限同步、高级分析和高级模板功能。',
      learnMore: '了解更多',
    },
    a11y: {
